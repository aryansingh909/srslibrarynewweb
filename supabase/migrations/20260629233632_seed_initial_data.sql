...
- 3 default plans (Monthly, 6-Month, Annual) with per-shift pricing.
- Sample announcements (welcome notice + holiday).
- Default gallery images (stock Pexels photos of study spaces).
- Default admin account (password hash for "Pathshala@Admin123").

## Notes
- Admin password is hashed with crypt() + gen_salt('bf', 12) — equivalent to bcrypt.
- Plans use a jsonb `shifts` array matching the schema spec.
*/
...
('https://images.pexels.com/photos/159780/books1.jpg?auto=compress&cs=tinysrgb&w=1200', 'Reading corner', 3),
('https://images.pexels.com/photos/1370298/pexels-photo-1370298.jpeg?auto=compress&cs=tinysrgb&w=1200', 'Quiet zone', 4),
('https://images.pexels.com/photos/256417/pexels-photo-256417.jpeg?auto=compress&cs=tinysrgb&w=1200', 'Reception area', 5),
('https://images.pexels.com/photos/1181406/pexels-photo-1181406.jpeg?auto=compress&cs=tinysrgb&w=1200', 'Study pods', 6)
ON CONFLICT DO NOTHING;
